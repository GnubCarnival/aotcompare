...
public class CustomCharacterManager : MonoBehaviour
{
  ...
  private int calTotalPoints() => this.setup.myCostume != null ? 0 + this.setup.myCostume.stat.SPD + this.setup.myCostume.stat.GAS + this.setup.myCostume.stat.BLA + this.setup.myCostume.stat.ACL : 400;
  ...
  {
    for (int index = 0; index < this.sexOption.Length; ++index)
    {
    ...
    for (int index = 0; index < this.eyeOption.Length; ++index)
    {
    ...
    this.faceId = -1;
    for (int index = 0; index < this.faceOption.Length; ++index)
    {
    ...
    this.glassId = -1;
    for (int index = 0; index < this.glassOption.Length; ++index)
    {
    ...
    for (int index = 0; index < this.hairOption.Length; ++index)
    {
    ...
    for (int index = 0; index < this.skinOption.Length; ++index)
    {
    ...
    this.capeId = !this.setup.myCostume.cape ? 0 : 1;
    for (int index = 0; index < this.divisionOption.Length; ++index)
    {
    ...
    for (int index = 0; index < this.skillOption.Length; ++index)
    {
  ...
  {
    if (!Object.op_Inequality((Object) this.setup, (Object) null) || this.setup.myCostume == null || !Object.op_Inequality((Object) this.setup.part_hair, (Object) null))
      return;
  ...
  {
    if (this.setup.myCostume == null || !Object.op_Inequality((Object) this.setup.part_hair, (Object) null))
      return;
  ...
  public void OnSoltChange(string id) => this.currentSlot = id;
  ...
  public void SaveData() => CostumeConeveter.HeroCostumeToLocalData(this.setup.myCostume, this.currentSlot);

  private void setHairColor()
  {
    if (Object.op_Inequality((Object) this.setup.part_hair, (Object) null))
  ...
  private void Start()
  {
    ...
    this.setup.setCharacterComponent();
    this.sexOption = new SEX[2]{ SEX.MALE, SEX.FEMALE };
    this.eyeOption = new int[28];
    for (int index = 0; index < 28; ++index)
      this.eyeOption[index] = index;
    this.faceOption = new int[14];
    for (int index = 0; index < 14; ++index)
      this.faceOption[index] = index + 32;
    this.glassOption = new int[10];
    for (int index = 0; index < 10; ++index)
      this.glassOption[index] = index + 48;
    this.hairOption = new int[11];
    for (int index = 0; index < 11; ++index)
      this.hairOption[index] = index;
    this.skinOption = new int[3];
    for (int index = 0; index < 3; ++index)
      this.skinOption[index] = index + 1;
    this.capeOption = new int[2];
    for (int index = 0; index < 2; ++index)
      this.capeOption[index] = index;
  ...
  public void toOption(CreatePart part, bool next)
  {
    switch (part)
    {
      case CreatePart.Sex:
        ...
        this.costumeId = this.sexId == 0 ? 11 : 0;
      ...
      case CreatePart.Face:
        ...
        if (Object.op_Equality((Object) this.setup.part_face, (Object) null))
      ...
      case CreatePart.Glass:
        ...
        if (Object.op_Equality((Object) this.setup.part_glass, (Object) null))
      ...
      case CreatePart.Skin:
        this.skinId = this.setup.myCostume.uniform_type == UNIFORM_TYPE.CasualAHSS ? 2 : (!next ? this.toPrev(this.skinId, 2) : this.toNext(this.skinId, 2));
        this.setup.myCostume.skin_color = this.skinOption[this.skinId];
        this.setup.myCostume.setTexture();
        this.setup.setSkin();
        break;
      case CreatePart.Costume:
        this.costumeId = this.setup.myCostume.uniform_type == UNIFORM_TYPE.CasualAHSS ? 25 : (this.sexId != 0 ? (!next ? this.toPrev(this.costumeId, 10) : this.toNext(this.costumeId, 10)) : (!next ? this.toPrev(this.costumeId, 24, 10) : this.toNext(this.costumeId, 24, 10)));
  ...
  public void toOption2(CreatePart part, bool next)
  {
    switch (part)
    {
      case CreatePart.Sex:
        this.sexId = !next ? this.toPrev(this.sexId, this.sexOption.Length) : this.toNext(this.sexId, this.sexOption.Length);
        this.costumeId = this.sexId != 0 ? 0 : 11;
        this.copyCostume(this.costumeOption[this.costumeId], this.setup.myCostume, true);
        this.setup.myCostume.sex = this.sexOption[this.sexId];
        this.character.GetComponent<CharacterCreateAnimationControl>().toStand();
        this.CostumeDataToMyID();
      ...
      case CreatePart.Hair:
        ...
        break;
      case CreatePart.Skin:
        this.skinId = this.setup.myCostume.uniform_type != UNIFORM_TYPE.CasualAHSS ? (!next ? this.toPrev(this.skinId, 2) : this.toNext(this.skinId, 2)) : 2;
        this.setup.myCostume.skin_color = this.skinOption[this.skinId];
        this.setup.myCostume.setTexture();
        this.setup.setSkin();
        break;
      case CreatePart.Costume:
        if (this.setup.myCostume.uniform_type == UNIFORM_TYPE.CasualAHSS)
        {
          ...
          this.costumeId = this.sexId == 0 ? (!next ? this.toPrev(this.costumeId, 24, 10) : this.toNext(this.costumeId, 24, 10)) : (!next ? this.toPrev(this.costumeId, 10) : this.toNext(this.costumeId, 10));
        this.copyBodyCostume(this.costumeOption[this.costumeId], this.setup.myCostume);
        this.setup.myCostume.setMesh2();
        this.setup.myCostume.setTexture();
        this.setup.createUpperBody2();
