...
// Type: ApplicationManagers.MainApplicationManager
  ...
  internal class MainApplicationManager : MonoBehaviour
  {
    ...
    public static void Init()
    {
      if (MainApplicationManager._firstLaunch)
      {
        ...
        MainApplicationManager._instance = SingletonFactory.CreateSingleton<MainApplicationManager>(MainApplicationManager._instance);
