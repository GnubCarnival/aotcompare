...
public class LevelInfo
{
  ...
  public static void Init()
  {
    ...
    LevelInfo.levels[0].minimapPreset = new Minimap.Preset(new Vector3(22.6f, 0.0f, 13f), 731.9738f);
    LevelInfo.levels[8].minimapPreset = new Minimap.Preset(new Vector3(8.8f, 0.0f, 65f), 765.5751f);
    LevelInfo.levels[9].minimapPreset = new Minimap.Preset(new Vector3(8.8f, 0.0f, 65f), 765.5751f);
    LevelInfo.levels[18].minimapPreset = new Minimap.Preset(new Vector3(443.2f, 0.0f, 1912.6f), 1929.042f);
    LevelInfo.levels[19].minimapPreset = new Minimap.Preset(new Vector3(443.2f, 0.0f, 1912.6f), 1929.042f);
    LevelInfo.levels[20].minimapPreset = new Minimap.Preset(new Vector3(2549.4f, 0.0f, 3042.4f), 3697.16f);
    LevelInfo.levels[21].minimapPreset = new Minimap.Preset(new Vector3(22.6f, 0.0f, 13f), 734.9738f);
  }
}
