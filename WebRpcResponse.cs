...
public class WebRpcResponse
{
  ...
  public string ToStringFull() => string.Format("{0}={2}: {1} \"{3}\"", (object) this.Name, (object) SupportClass.DictionaryToString((IDictionary) this.Parameters), (object) this.ReturnCode, (object) this.DebugMessage);
