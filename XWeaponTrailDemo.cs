...
public class XWeaponTrailDemo : MonoBehaviour
{
  ...
  private void OnGUI()
  {
    if (GUI.Button(new Rect(0.0f, 0.0f, 150f, 30f), "Activate Trail1"))
    {
    ...
    if (GUI.Button(new Rect(0.0f, 30f, 150f, 30f), "Stop Trail1"))
      this.SimpleTrail.Deactivate();
    if (GUI.Button(new Rect(0.0f, 60f, 150f, 30f), "Stop Trail1 Smoothly"))
      this.SimpleTrail.StopSmoothly(0.3f);
    if (GUI.Button(new Rect(0.0f, 120f, 150f, 30f), "Activate Trail2"))
    {
      this.SimpleTrail.Deactivate();
      this.SwordAnimation.Play();
    ...
    if (GUI.Button(new Rect(0.0f, 150f, 150f, 30f), "Stop Trail2"))
    {
      this.ProTrailDistort.Deactivate();
      this.ProTrailShort.Deactivate();
      this.ProTraillong.Deactivate();
    }
    if (!GUI.Button(new Rect(0.0f, 180f, 150f, 30f), "Stop Trail2 Smoothly"))
      return;
