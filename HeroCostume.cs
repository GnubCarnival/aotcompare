...
public class HeroCostume
{
  ...
  public Color hair_color = new Color(0.5f, 0.1f, 0.0f);
  ...
  public static void init()
  {
    ...
    CostumeHair.init();
    HeroCostume.body_uniform_ma_texture = new string[3]
    {
      "aottg_hero_uniform_ma_1",
      "aottg_hero_uniform_ma_2",
      "aottg_hero_uniform_ma_3"
    };
    HeroCostume.body_uniform_fa_texture = new string[3]
    {
      "aottg_hero_uniform_fa_1",
      "aottg_hero_uniform_fa_2",
      "aottg_hero_uniform_fa_3"
    };
    HeroCostume.body_uniform_mb_texture = new string[4]
    {
    ...
    HeroCostume.body_uniform_fb_texture = new string[2]
    {
      "aottg_hero_uniform_fb_1",
      "aottg_hero_uniform_fb_2"
    };
    HeroCostume.body_casual_ma_texture = new string[3]
    {
      "aottg_hero_casual_ma_1",
      "aottg_hero_casual_ma_2",
      "aottg_hero_casual_ma_3"
    };
    HeroCostume.body_casual_fa_texture = new string[3]
    {
      "aottg_hero_casual_fa_1",
      "aottg_hero_casual_fa_2",
      "aottg_hero_casual_fa_3"
    };
    HeroCostume.body_casual_mb_texture = new string[4]
    {
    ...
    HeroCostume.body_casual_fb_texture = new string[2]
    {
    ...
    HeroCostume.costume[34].hair_color = new Color(0.41f, 1f, 0.0f);
    ...
    HeroCostume.costume[35].hair_color = new Color(0.0f, 1f, 0.874f);
    ...
    for (int index = 0; index < HeroCostume.costume.Length; ++index)
    {
      HeroCostume.costume[index].stat = HeroStat.getInfo("CUSTOM_DEFAULT");
      HeroCostume.costume[index].id = index;
      HeroCostume.costume[index].setMesh2();
      HeroCostume.costume[index].setTexture();
    }
  ...
  public void setMesh()
  {
    ...
    else if (this.uniform_type == UNIFORM_TYPE.CasualA)
    {
      ...
      this.body_mesh = this.sex != SEX.FEMALE ? "character_body_casual_MA" : "character_body_casual_FA";
    }
    else if (this.uniform_type == UNIFORM_TYPE.CasualB)
    {
      this.arm_l_mesh = "character_arm_casual_l";
      this.arm_r_mesh = "character_arm_casual_r";
      this.body_mesh = this.sex != SEX.FEMALE ? "character_body_casual_MB" : "character_body_casual_FB";
    }
    ...
    this.beard_mesh = this.beard_texture_id < 0 ? string.Empty : "character_face";
    this.glass_mesh = this.glass_texture_id < 0 ? string.Empty : "glass";
    this.setCape();
  }
  ...
  {
    this._3dmg_texture = this.uniform_type != UNIFORM_TYPE.CasualAHSS ? "AOTTG_HERO_3DMG" : "aottg_hero_AHSS_3dmg";
