...
public class PhotonStatsGui : MonoBehaviour
{
  ...
  public void Start() => ((Rect) ref this.statsRect).x = (float) Screen.width - ((Rect) ref this.statsRect).width;
  ...
  public void TrafficStatsWindow(int windowID)
  {
    ...
    string str1 = string.Format("Out|In|Sum:\t{0,4} | {1,4} | {2,4}", (object) trafficStatsGameLevel.TotalOutgoingMessageCount, (object) trafficStatsGameLevel.TotalIncomingMessageCount, (object) trafficStatsGameLevel.TotalMessageCount);
    string str2 = string.Format("{0}sec average:", (object) num);
    string str3 = string.Format("Out|In|Sum:\t{0,4} | {1,4} | {2,4}", (object) ((long) trafficStatsGameLevel.TotalOutgoingMessageCount / num), (object) ((long) trafficStatsGameLevel.TotalIncomingMessageCount / num), (object) ((long) trafficStatsGameLevel.TotalMessageCount / num));
