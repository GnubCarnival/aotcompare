...
// Type: Settings.LegacyGameSettings
...
namespace Settings
{
  internal class LegacyGameSettings : SaveableSettingsContainer
  {
    ...
    public FloatSetting TitanSpawnNormal = new FloatSetting(20f, 0.0f, 100f);
    public FloatSetting TitanSpawnAberrant = new FloatSetting(20f, 0.0f, 100f);
    public FloatSetting TitanSpawnJumper = new FloatSetting(20f, 0.0f, 100f);
    public FloatSetting TitanSpawnCrawler = new FloatSetting(20f, 0.0f, 100f);
    public FloatSetting TitanSpawnPunk = new FloatSetting(20f, 0.0f, 100f);
    public BoolSetting TitanSizeEnabled = new BoolSetting(false);
    public FloatSetting TitanSizeMin = new FloatSetting(1f, 0.0f, 100f);
    public FloatSetting TitanSizeMax = new FloatSetting(3f, 0.0f, 100f);
