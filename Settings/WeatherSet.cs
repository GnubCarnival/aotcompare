...
namespace Settings
{
  internal class WeatherSet : BaseSetSetting
  {
    ...
    public ColorSetting Flashlight = new ColorSetting(new Color(1f, 1f, 1f, 0.0f));
    public FloatSetting FogDensity = new FloatSetting(0.0f, 0.0f, 1f);
    public ColorSetting FogColor = new ColorSetting(new Color(0.5f, 0.5f, 0.5f));
    public FloatSetting Rain = new FloatSetting(0.0f, 0.0f, 1f);
    public FloatSetting Thunder = new FloatSetting(0.0f, 0.0f, 1f);
    public FloatSetting Snow = new FloatSetting(0.0f, 0.0f, 1f);
    public FloatSetting Wind = new FloatSetting(0.0f, 0.0f, 1f);
